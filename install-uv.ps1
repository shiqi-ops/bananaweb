...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrls = @("$installer_base_url/astral-sh/uv/releases/download/0.11.2")
} elseif ($env:UV_INSTALLER_GITHUB_BASE_URL) {
  $installer_base_url = $env:UV_INSTALLER_GITHUB_BASE_URL
  $ArtifactDownloadUrls = @("$installer_base_url/astral-sh/uv/releases/download/0.11.2")
} else {
  $ArtifactDownloadUrls = @("https://releases.astral.sh/github/uv/releases/download/0.11.2", "https://github.com/astral-sh/uv/releases/download/0.11.2")
}
